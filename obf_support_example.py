...
if __name__ == '__main__':
    ...
    file_path = 'P:\Private\practice\imaging\IF\IF74_correl_LI50\IF74_corrle_LI5_STEDycon\IMG0013_IF74_correl_LI50_spl1_real-loop.obf'
    ...
    for stack in obf.stacks:
        ...
        im = ax.imshow(data[tuple(idx)], cmap=cm.hot)
