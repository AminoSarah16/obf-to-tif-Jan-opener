...
def main():
    ...
    for filename in filenames:
        ...
        for stack in wanted_stacks:
            ...
            # create metadata library:
            image_size = stack.lengths
            print('stack lengths: {}'.format(stack.lengths))
            pixel_size = stack.pixel_sizes
            print('stack pixel sizes: {}'.format(pixel_size))

            exif = {"Pixel_size: 0.0150x0.0150 micron^2"}
            ...
            img.save(output_file, format='tiff', exif=exif)

#Pixel size: 0.0150x0.0150 "micron^2"
